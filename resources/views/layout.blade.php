...
<div id="horizon" v-cloak>
    ...
    <div class="container mb-5">
        <div class="flex items-center py-4 header">
            <button class="mobile-menu-toggle btn btn-muted mr-2 lg:hidden" @click="toggleMobileMenu" aria-label="Toggle Menu">
            ...
            <router-link to="/" class="logo flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" class="logo-icon">
                ...
                <h1 class="text-2xl font-normal mb-0 ml-2 logo-text">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 mt-4">
            <div class="lg:col-span-2 sidebar-column">
                <div class="sidebar" :class="{'mobile-menu-open': mobileMenuOpen}" @click.self="closeMobileMenu">
                <ul class="nav flex flex-col">
                    <li class="nav-item">
                        <router-link active-class="active" to="/dashboard" class="nav-link flex items-center">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/monitoring" class="nav-link flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/metrics" class="nav-link flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/batches" class="nav-link flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/jobs/pending" class="nav-link flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/jobs/completed" class="nav-link flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/jobs/silenced" class="nav-link flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <li class="nav-item">
                        <router-link active-class="active" to="/failed" class="nav-link flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <div class="lg:col-span-10 col-12">
