    ...
    <div>
        <div class="card overflow-hidden">
            <div class="card-header flex items-center justify-between">
                <h2 class="text-base font-semibold m-0" v-if="$route.params.type == 'pending'">Pending Jobs</h2>
                <h2 class="text-base font-semibold m-0" v-if="$route.params.type == 'completed'">Completed Jobs</h2>
                <h2 class="text-base font-semibold m-0" v-if="$route.params.type == 'silenced'">Silenced Jobs</h2>
            </div>

            <div v-if="!ready"
                 class="flex items-center justify-center card-bg-secondary p-5 bottom-radius">
            ...
            <div v-if="ready && jobs.length == 0"
                 class="flex flex-col items-center justify-center card-bg-secondary p-5 bottom-radius">
