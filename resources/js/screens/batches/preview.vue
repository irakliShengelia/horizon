    ...
    <div>
        <div class="card overflow-hidden">
            <div class="card-header flex items-center justify-between">
                <h2 class="text-base font-semibold m-0" v-if="!ready">Batch Preview</h2>
                <h2 class="text-base font-semibold m-0" v-if="ready">{{batch.name || batch.id}}</h2>
        ...
        <div class="card overflow-hidden mt-4" v-if="ready && failedJobs.length">
            <div class="card-header flex items-center justify-between">
                <h2 class="text-base font-semibold m-0">Failed Jobs</h2>
            </div>
